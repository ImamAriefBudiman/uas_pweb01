...
<html>
    ...
    <body>
        ...
        <div class='container mt-3'>
			<div class='row'>
				<div class='col-md-12'>
					<h2 class='text-muted mb-4'>Menu</h2>
					...
					<table class='table table-striped table-bordered'>
						...
						<?php foreach($items as $item): ?>
							<tr>
								...
								<td>Rp; <span class='row_total'><?php echo $item["total"];?></span></td>
						...
						<tfoot>
							<tr>
								<td colspan='3'><a href='index.php' class="btn btn-success">Lanjutkan Belanja</a></td>
								<th>Total</th>
								<th>Rp;  <span id='total'><?php echo $cart->get_cart_total();?></span></th>
